...
update_feeds() {
    ...
    if ! grep -q "small-package" "$FEEDS_PATH"; then
        ...
        echo "src-git small8 https://github.com/rodren-lion/openwrt-small-package" >>"$FEEDS_PATH"
    fi
...
update_ath11k_fw() {
    ...
    local url="https://raw.githubusercontent.com/corecoolceo/LiBwrt-6.12.23/kernel-6.12/package/firmware/ath11k-firmware/Makefile"
...
update_argon() {
    local repo_url="https://github.com/xiaobailong6/luci-theme-argon.git"
